...
// First returns the first Sink entity from the query.
// Returns a *NotFoundError when no Sink was found.
func (sq *SinkQuery) First(ctx context.Context) (*Sink, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{sink.Label}
	}
	return nodes[0], nil
}
...
// FirstID returns the first Sink ID from the query.
// Returns a *NotFoundError when no Sink ID was found.
...
// Only returns a single Sink entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one Sink entity is found.
// Returns a *NotFoundError when no Sink entities are found.
func (sq *SinkQuery) Only(ctx context.Context) (*Sink, error) {
	...
	case 0:
		return nil, &NotFoundError{sink.Label}
	default:
		return nil, &NotSingularError{sink.Label}
	}
}
...
// OnlyID is like Only, but returns the only Sink ID in the query.
// Returns a *NotSingularError when more than one Sink ID is found.
...
func (sq *SinkQuery) OnlyID(ctx context.Context) (id string, err error) {
	...
	case 0:
		err = &NotFoundError{sink.Label}
	default:
		err = &NotSingularError{sink.Label}
	}
	return
}
...
func (sq *SinkQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
	if err := sq.Select(sink.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
// Clone returns a duplicate of the SinkQuery builder, including all associated steps. It can be
...
func (sq *SinkQuery) Clone() *SinkQuery {
	...
	return &SinkQuery{
		...
		predicates: append([]predicate.Sink{}, sq.predicates...),
...
func (sq *SinkQuery) GroupBy(field string, fields ...string) *SinkGroupBy {
	grbuild := &SinkGroupBy{config: sq.config}
...
func (sq *SinkQuery) Select(fields ...string) *SinkSelect {
	...
	selbuild := &SinkSelect{SinkQuery: sq}
	selbuild.label = sink.Label
...
func (sq *SinkQuery) prepareQuery(ctx context.Context) error {
...
func (sq *SinkQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Sink, error) {
	var (
		nodes = []*Sink{}
		_spec = sq.querySpec()
	)
	_spec.ScanValues = func(columns []string) ([]any, error) {
		return (*Sink).scanValues(nil, columns)
	}
	_spec.Assign = func(columns []string, values []any) error {
		node := &Sink{config: sq.config}
...
func (sq *SinkQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := sq.querySpec()
...
func (sq *SinkQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (sq *SinkQuery) querySpec() *sqlgraph.QuerySpec {
...
func (sq *SinkQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(sq.driver.Dialect())
	t1 := builder.Table(sink.Table)
	columns := sq.fields
	if len(columns) == 0 {
		columns = sink.Columns
	}
...
func (sgb *SinkGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (sgb *SinkGroupBy) sqlQuery() *sql.Selector {
...
func (ss *SinkSelect) Scan(ctx context.Context, v any) error {
	...
	ss.sql = ss.SinkQuery.sqlQuery(ctx)
	return ss.sqlScan(ctx, v)
}

func (ss *SinkSelect) sqlScan(ctx context.Context, v any) error {
